...
B<NetSDS::Proc> - common application superclass
...
C<NetSDS::Proc> is a base class for NetSDS applications.
...
New application should be inherited from C<NetSDS::Proc> class
...
To add more flexibility to application development C<NetSDS::Proc> framework allows to add pluggable features.
